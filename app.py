...
# --- Compute ideal per-member quota for even split ---
total_products = len(product_df)
ideal_targets = {m: min(member_limit(m), total_products // num_members) for m in team_members}
...
for div in product_df['Division'].unique():
    ...
    while div_rows:
        ...
        # Assign one product at a time to maintain evenness
